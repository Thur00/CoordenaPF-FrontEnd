    ...
    if (isEditing) {
      try {
        ...
        await fetch(`${API_URL}/usuarios/${editingItem.Login_id}`, {
          ...
          body: JSON.stringify({ Login_id: formData.Login_id, Nome: formData.Nome, Cargo: formData.Cargo, Email: formData.Email, Senha: formData.Senha, CPF: formData.CPF }), // Ajuste aqui o objeto para corresponder ao que a API espera
        });
      ...
      try {
        ...
        const response = await fetch(`${API_URL}/usuarios`, {
          ...
          body: JSON.stringify({ Login_id: formData.Login_id, Nome: formData.Nome, Cargo: formData.Cargo, Email: formData.Email, Senha: formData.Senha, CPF: formData.CPF }),
        });
